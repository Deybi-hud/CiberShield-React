    ...
    return (
      <main>
        ...
        <div className="contenedor-carrito">
          {carritoComprar && (<Text as="p" className="carrito-comprado">{' '}¡Gracias por tu compra! <i className="bi bi-emoji-smile"></i></Text>
          )}
          
          {carritoVacio && !carritoComprar && (
          ...
          {!carritoVacio && (
            <>
              ...
              <div className="carrito-acciones">
                <Button className="carrito-acciones-vaciar" onClick={handleVaciar}>
                  Vaciar Carrito
                </Button>
